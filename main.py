...
from src.email_sender import send_email, get_summary_from_json_html
...
if __name__ == "__main__":
    ...
    try:
        ...
        body = get_summary_from_json_html("data/article_test.json")
        send_email(body, os.getenv("RECIPIENT_EMAIL_ADDRESS"))
